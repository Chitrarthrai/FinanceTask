...
const colorStyles: Record<string, string> = {
  ...
  rose: "bg-rose-500 text-white dark:bg-rose-500/20 dark:text-rose-400",
  blue: "bg-blue-500 text-white dark:bg-blue-500/20 dark:text-blue-400",
  brand: "bg-brand-500 text-white dark:bg-brand-500/20 dark:text-brand-400",
  amber: "bg-amber-500 text-white dark:bg-amber-500/20 dark:text-amber-400",
  indigo: "bg-indigo-500 text-white dark:bg-indigo-500/20 dark:text-indigo-400",
};
